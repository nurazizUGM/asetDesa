...
<html lang="en">
  ...
  <body>
    ...
    <footer class="bg-dark text-white text-center pt-4">
      <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <a href="https://djardev.net" target="_blank">djardev</a></strong>
      <br/>
    </footer>
